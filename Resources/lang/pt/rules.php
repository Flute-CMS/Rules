...
return [
    ...
    'back_to_rules' => 'Voltar às regras',
    ...
    'admin' => [
        ...
        'fields' => [
            ...
            'no_parent' => 'Sem pai (nível superior)',
        ],
        'placeholders' => [
        ...
        'helps' => [
            'content' => 'Conteúdo de texto rico para esta categoria',
        ...
        'messages' => [
            ...
            'confirm_delete' => 'Tem certeza de que deseja excluir esta categoria de regras?',
            'invalid_sort_data' => 'Dados de ordenação inválidos',
            'categories_reordered' => 'Ordem das categorias atualizada',
            'cannot_set_self_as_parent' => 'Não é possível definir categoria como próprio pai',
